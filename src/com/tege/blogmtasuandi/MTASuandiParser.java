...
import com.tege.blogmtasuandi.MTASuandiItem;

public class MTASuandiParser extends DefaultHandler {
	private final static String TAG_ITEM = "item";
	private final static String[] xmltags = { "title", "link", "pubDate", "description" };
	
	private MTASuandiItem currentitem = null;
	private ArrayList<MTASuandiItem> itemarray = null;
	private int currentindex = -1;
	private boolean isParsing = false;
	private StringBuilder builder = new StringBuilder();
	
	public MTASuandiParser(ArrayList<MTASuandiItem> itemarray) {
		super();
